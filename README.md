# Deadlock-AHK-External v0.39

Пофиксили спидхак, игру удалил. Оффсеты обновлять самостоятельно, инструкция ниже(обновил).

Если не получается обновить, помогу за денюшку на [Boosty](https://boosty.to/kramar1337)
...
____Оффсеты тип "m.": (устаревают раз в 2-4 недели)____
...
____Оффсеты тип "dw.": (устаревают оч редко)____
