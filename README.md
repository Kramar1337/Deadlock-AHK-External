...
BoneMode=1
; 1 - Голова и Шея рандомно 60/40%, 2 - Шея, 3 - Тело, 4 - Голова 90%
HeadOrNeckOrBody=1
...
ESPHPbarTeam=0
; Задержка отрисовки. 0 - плавные квадраты, > 15 - выше производительнось
ESPSleepCpu=15
